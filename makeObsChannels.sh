...
combine -M MultiDimFit workspaceWithAsimovObs.root --algo=grid --points 100 -m 220 -n 2D_exp -D toys/toy_asimov -v 3 --setPhysicsModelParameterRanges CMS_zz4l_GGsm=0.0001,2 ;
#root -l -q ../../../utils/plotScan1D.C\(220,2\) ; #-q;
cd ..;
done
