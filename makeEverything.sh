...
combine -M MultiDimFit workspaceWithAsimov.root --algo=grid --points 100 -m 220 -n 2D_exp -D toys/toy_asimov -v 3
...
combine -M GenerateOnly hzz4l_allS_8TeV.root -m 220 -t -1 --expectSignal=1 --saveToys -V -v 1
root -b -l -q ../../../utils/addToyDataset.C\(\"hzz4l_allS_8TeV.root\",\"higgsCombineTest.GenerateOnly.mH220.123456.root\",\"toy_asimov\",\"workspaceWithAsimov.root\"\)
